...
class EN:
    ...
    REGISTER_ONLY_ONE_USER = 'You can only have one account!'
    REGISTER_ONLY_ONE_USER_2 = ' can no longer register more accounts.'
...
class ES:
    ...
    REGISTER_ONLY_ONE_USER = '¡Solo puedes tener un cuenta!'
    REGISTER_ONLY_ONE_USER_2 = ' ya no puede registrar cuentas.'
